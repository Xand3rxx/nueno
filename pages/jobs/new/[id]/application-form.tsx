...
export default function JobsNew() {
  ...
  useEffect(() => {
    if (router.asPath !== router.route) {
      autoGenerateDefaultFields();
      getJobApplicationFormFields();
    }
  }, [router.isReady]);

  /**
   * @description Auto generate default fields for the current job appplication form in view.
   *
   * @return response: number
   */
  async function autoGenerateDefaultFields() {
    if (!jobUid) return;
